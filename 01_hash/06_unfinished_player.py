...
def solution(participant, completion):
    result_dict = Counter(participant) - Counter(completion)
    result = next(iter(result_dict))
    return result

# --------------------------------------------------------------------------
# 풀이 메모 — gist 코멘트에서 옮겨온 기록이다 (2026-08-29 이관).
# 문제를 풀며 남긴 시행착오이므로 당시 문장을 그대로 둔다.
# 원본: https://gist.github.com/silver-ring-data/a56a9c389ac88f414a2a6d5e6096e3d9
#
# [2026-03-03]
